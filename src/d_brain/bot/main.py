...
def create_dispatcher() -> Dispatcher:
    ...
    from d_brain.bot.handlers import buttons, commands, do, forward, photo, process, strategy, text, voice, weekly
    ...
    dp.include_router(strategy.router)  # Strategy session handler
